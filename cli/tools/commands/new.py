...
from tools.download_manager import mkdir
...
def setup(subparser):
    ...
    subparser.add_argument(
        "-t", "--toolchain", default="gnu", help="Project to be created")
    subparser.add_argument(
        '-o', '--output', action='store', help='Generated application files directory')
